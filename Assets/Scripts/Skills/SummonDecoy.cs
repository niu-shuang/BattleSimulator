...
public class SummonDecoy : SkillBase
{
    ...
    public SummonDecoy(int id, string skillName, SkillType skillType, int cost, bool selectable, CharacterLogic caster, string description) : base(id, skillName, skillType, cost, selectable, caster, description)
    {
    }
    ...
    public override bool Cast(Vector2Int targetPos, Team team)
    {
        ...
        Decoy drone = new Decoy(-1, pos, droneName, droneHp, caster.team, droneAtk, droneDef, GameDefine.CharacterType.Mechanical, 0, aliveTime);
